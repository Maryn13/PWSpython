...
UPDATE_TARGET_EVERY = 100  # Terminal states (end of episodes) #100
MODEL_NAME = '2x256'
...
class BlobEnv:
    ...
    def reset(self):
        ...
        if self.RETURN_IMAGES:
            ...
            observation = [self.player.x-self.food.x, self.player.y-self.food.y, self.player.x-self.enemy.x, self.player.y-self.enemy.y]
    ...
    def step(self, action):
        ...
        if self.RETURN_IMAGES:
            ...
            new_observation = [self.player.x-self.food.x, self.player.y-self.food.y, self.player.x-self.enemy.x, self.player.y-self.enemy.y]
...
class DQNAgent:
    ...
    def create_model(self):
        ...
        model.add(nn.Layer_Dense(4, 256))
        ...
        model.add(nn.Layer_Dense(256, env.ACTION_SPACE_SIZE))
